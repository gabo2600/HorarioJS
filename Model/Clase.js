...
const Path = p.join(require('os').homedir(),"HorarioDB/clases.json");
const Path2 = p.join(require('os').homedir(),"HorarioDB/horario.json");

if (!fs.existsSync(p.join(require('os').homedir(),"HorarioDB"))){
    fs.mkdirSync(p.join(require('os').homedir(),"HorarioDB"));
}
